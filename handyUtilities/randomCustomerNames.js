...
function randomCustomerNames(xNumber) {
  ...
  while (t <= xNumber) {
    honorific = selectHonorific().toString();
    initials = selectInitials().toString();
    lastName = selectLastName().toString();
...
console.log(randomCustomerNames(32));
